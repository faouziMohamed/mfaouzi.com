...
export const projectSectionData: Project = {
  ...
  ProjectDetails: [
    ...
    },
    {
      ...
      endDate: '-1',
      srcLink: '',
      liveLink: 'https://trust4finance.mfaouzi.com',
      technologies: [
        'Spring Boot',
        'NextJs',
        'MaterialUi',
    ...
    },
    {
      name: 'Amana Pilot',
      summary: '',
      description: 'A platform to manage finance for small and mid companies',
      startDate: '10/2023',
      endDate: '-1',
      srcLink: '',
      liveLink: 'https://amana-pilot.trust4finance.com',
      technologies: [
        'Spring Boot',
        'NextJs',
        'MaterialUi',
    ...
    },
    {
      ...
      liveLink: 'https://trakz.vercel.app',
